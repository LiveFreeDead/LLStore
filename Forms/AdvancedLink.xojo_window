#tag DesktopWindow
Begin DesktopWindow AdvancedLink
   Backdrop        =   0
...
#tag Events TextPM
	#tag Event
		Sub TextChanged()
		  ItemLnk(EditingLnk).LnkPMCompatible = Me.Text.Trim
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events TextDE
	#tag Event
		Sub TextChanged()
		  ItemLnk(EditingLnk).LnkDECompatible = Me.Text.Trim
